...
public class Admin implements User {
    ...
    public Course createCourse(int courseId, String courseName, Teacher teacher) {
        ...
        for (Course courses : courses) {
            if (courses.getCourseId() == courseId) {
                System.out.println("Course ID " + courseId + " already exists. Please enter a different ID.");
                return null;
            }
        }
        addCourse(course);
    ...
    // Итераторы для студентов, учителей и курсов
    public Iterator<Student> studentIterator() {
        return students.iterator();
    }

    public Iterator<Teacher> teacherIterator() {
        return teachers.iterator();
    }

    public Iterator<Course> courseIterator() {
    ...
    public List<Student> getAllStudents() {
        ...
        Iterator<Student> studentIterator = studentIterator();
    ...
    public List<Teacher> getAllTeachers() {
        ...
        Iterator<Teacher> teacherIterator = teacherIterator();
    ...
    public List<Course> getAllCourses() {
        ...
        Iterator<Course> courseIterator = courseIterator();
